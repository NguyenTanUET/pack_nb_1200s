...
3. Records results in result/pack_no_bound_1200s.csv with columns:
...
def main():
    ...
    output_file = result_dir / "pack_no_bound_1200s.csv"
    ...
    local_path = "result/pack_no_bound_1200s.csv"
